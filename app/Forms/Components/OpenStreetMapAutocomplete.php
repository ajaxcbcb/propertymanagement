...
class OpenStreetMapAutocomplete extends TextInput
{
    protected string $view = 'forms.components.openstreetmap-autocomplete';

    protected function setUp(): void
    {
        parent::setUp();

        $this->afterStateHydrated(function (OpenStreetMapAutocomplete $component, $state) {
